...
public class beverages extends Login1 {
	
	public String customerName = ""; // Initialize customer name
    public JFrame frmBeveragesMenu;
    
    //Mountain Dew
    public int mountainDewQuantity = 0; // Quantity of Mountain Dew
    public double mountainDewPrice = 25.00; // Price of Mountain Dew
    ...
    public double spritePrice = 15.00; // Price of Sprite
    ...
    public double PepsiPrice = 20.00; // Price of Sprite
 ...
 // Method to insert order details into the database
    ...
    private static String simulateLogin(String email, String password) {
        String customerName = "";
        try {
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/create_data", "root", "");

            String sql = "SELECT * FROM accounts WHERE username=? AND password=?";
            PreparedStatement statement = con.prepareStatement(sql);
            statement.setString(1, email);
            statement.setString(2, password);
           // Assuming no user name is provided in this form

            ResultSet result = statement.executeQuery();

            if (result.next()) {
                // Login successful, set the customer name
                customerName = result.getString("first_name") + " " + result.getString("last_name");
            }
    ...
    private void initialize() {
        frmBeveragesMenu = new JFrame();
        frmBeveragesMenu.getContentPane().setBackground(Color.WHITE);
        frmBeveragesMenu.setTitle("Beverages Menu");
        frmBeveragesMenu.setIconImage(Toolkit.getDefaultToolkit().getImage(beverages.class.getResource("/windowBuilder/images/new_beverages.png")));
        frmBeveragesMenu.setBounds(100, 100, 1162, 695);
        frmBeveragesMenu.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        frmBeveragesMenu.getContentPane().setLayout(null);

        JLabel lblMountainDew = new JLabel("Mountain Dew");
        lblMountainDew.setFont(new Font("Sylfaen", Font.PLAIN, 21));
        lblMountainDew.setBounds(217, 153, 150, 29);
        frmBeveragesMenu.getContentPane().add(lblMountainDew);

        JLabel lblMountainDewPrice = new JLabel("P 25.00"); // Display initial price
        lblMountainDewPrice.setFont(new Font("Sylfaen", Font.PLAIN, 21));
        lblMountainDewPrice.setBounds(217, 195, 150, 29);
        frmBeveragesMenu.getContentPane().add(lblMountainDewPrice);
        ...
        frmBeveragesMenu.getContentPane().add(btnAddMountainDew);
        ...
        frmBeveragesMenu.getContentPane().add(btnSubtractMountainDew);
        ...
        frmBeveragesMenu.getContentPane().add(txtMountainDewQuantity);
        ...
        frmBeveragesMenu.getContentPane().add(lblMountainDewTotal);
        ...
        frmBeveragesMenu.getContentPane().add(txtMountainDewTotalPrice);
        txtMountainDewTotalPrice.setColumns(10);

        JLabel lblNewLabel = new JLabel("");
        lblNewLabel.setIcon(new ImageIcon(beverages.class.getResource("/windowBuilder/images/drink.png")));
        lblNewLabel.setBounds(446, 126, 159, 203);
        frmBeveragesMenu.getContentPane().add(lblNewLabel);

        JLabel lblSprite = new JLabel("Sprite");
        lblSprite.setFont(new Font("Sylfaen", Font.PLAIN, 21));
        lblSprite.setBounds(602, 153, 68, 29);
        frmBeveragesMenu.getContentPane().add(lblSprite);

        JLabel lblSpritePrice = new JLabel("P 15.00"); // Display initial price
        lblSpritePrice.setFont(new Font("Sylfaen", Font.PLAIN, 21));
        lblSpritePrice.setBounds(602, 195, 85, 29);
        frmBeveragesMenu.getContentPane().add(lblSpritePrice);
        ...
        frmBeveragesMenu.getContentPane().add(btnAddSprite);
        ...
        frmBeveragesMenu.getContentPane().add(btnSubtractSprite);
        ...
        frmBeveragesMenu.getContentPane().add(txtSpriteQuantity);
        ...
        frmBeveragesMenu.getContentPane().add(lblSpriteTotal);
        ...
        frmBeveragesMenu.getContentPane().add(txtSpriteTotalPrice);
        txtSpriteTotalPrice.setColumns(10);
        
        JLabel lblNewLabel_1 = new JLabel("");
        lblNewLabel_1.setIcon(new ImageIcon(beverages.class.getResource("/windowBuilder/images/d.png")));
        lblNewLabel_1.setBounds(105, 126, 102, 198);
        frmBeveragesMenu.getContentPane().add(lblNewLabel_1);
        
        JDesktopPane desktopPane = new JDesktopPane();
        desktopPane.setBackground(new Color(0, 0, 0));
        desktopPane.setBounds(0, 11, 1364, 90);
        frmBeveragesMenu.getContentPane().add(desktopPane);
        
        JLabel lblNewLabel_3 = new JLabel("BEVERAGES");
        lblNewLabel_3.setFont(new Font("Yu Gothic UI Semibold", Font.BOLD, 34));
        lblNewLabel_3.setForeground(new Color(255, 255, 255));
        lblNewLabel_3.setBounds(471, 23, 218, 36);
     ...
     // Add to cart for Mountain Dew
        btnAdd_cart.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
            	if (mountainDewQuantity == 0) {
                    JOptionPane.showMessageDialog(frmBeveragesMenu,"Please order First.");
                    return; // Exit the method if quantity is zero
                }

               

                // Insert the order using the retrieved customer name
                insertOrder(customerName, "Mountain Dew", mountainDewQuantity, mountainDewQuantity * mountainDewPrice);
                ...
                JOptionPane.showMessageDialog(frmBeveragesMenu, "Mountain Dew added to cart successfully.");
            }
        });
        ...
        frmBeveragesMenu.getContentPane().add(btnAdd_cart);
        ...
        btnAdd_cart_1.addActionListener(new ActionListener() {
        	 public void actionPerformed(ActionEvent e) {
                 ...
                 // Insert the order using the retrieved customer name
                 insertOrder(customerName, "Sprite",spriteQuantity, spriteQuantity * spritePrice);
                spriteQuantity = 0;
                 // Update Mountain Dew quantity text field
                 updateMountainDewQuantityField();
                 // Reset Mountain Dew total price to its initial value
        ...
        frmBeveragesMenu.getContentPane().add(btnAdd_cart_1);
        
        JLabel lblNewLabel_2 = new JLabel("");
        lblNewLabel_2.setIcon(new ImageIcon(beverages.class.getResource("/windowBuilder/images/new_pepsi.png")));
        lblNewLabel_2.setBounds(772, 112, 159, 203);
        frmBeveragesMenu.getContentPane().add(lblNewLabel_2);
        
        JLabel lblPepsi = new JLabel("Pepsi");
        lblPepsi.setFont(new Font("Sylfaen", Font.PLAIN, 21));
        lblPepsi.setBounds(941, 153, 68, 29);
        frmBeveragesMenu.getContentPane().add(lblPepsi);
        
        JLabel lblPepsiPrice = new JLabel("P 20.00");
        lblPepsiPrice.setFont(new Font("Sylfaen", Font.PLAIN, 21));
        lblPepsiPrice.setBounds(941, 195, 85, 29);
        frmBeveragesMenu.getContentPane().add(lblPepsiPrice);
        ...
        frmBeveragesMenu.getContentPane().add(btnSubtractPepsi);
        ...
        frmBeveragesMenu.getContentPane().add(txtPepsiQuantity);
        ...
        frmBeveragesMenu.getContentPane().add(btnAddPepsi);
        ...
        frmBeveragesMenu.getContentPane().add(lblPepsiTotal);
        ...
        btnAdd_cart_pepsi.addActionListener(new ActionListener() {
        	 public void actionPerformed(ActionEvent e) {
                 ...
                 // Insert the order using the retrieved customer name
                 insertOrder(customerName, "Pepsi", PepsiQuantity, PepsiQuantity * mountainDewPrice);
                 mountainDewQuantity = 0;
                 // Update Mountain Dew quantity text field
                 updateMountainDewQuantityField();
                 // Reset Mountain Dew total price to its initial value
        ...
        frmBeveragesMenu.getContentPane().add(btnAdd_cart_pepsi);
        ...
        frmBeveragesMenu.getContentPane().add(desktopPane_1_1);
        ...
        frmBeveragesMenu.getContentPane().add(desktopPane_2_1);
        
        JDesktopPane desktopPane_4 = new JDesktopPane();
        desktopPane_4.setBackground(new Color(255, 128, 0));
        desktopPane_4.setBounds(62, 490, 1010, 11);
        frmBeveragesMenu.getContentPane().add(desktopPane_4);
        ...
        frmBeveragesMenu.getContentPane().add(desktopPane_2_1_1);
        ...
        frmBeveragesMenu.getContentPane().add(desktopPane_4_1);
    ...
    private void updateMountainDewQuantityField() {
        ...
        frmBeveragesMenu.revalidate();
        frmBeveragesMenu.repaint();
    }
 ...
 // Add a method to update the customer name
    private void updateCustomerName(String newCustomerName) {
